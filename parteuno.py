...
class parteuno(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "parteuno")
        ...
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "Nivel diente de sierra", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, fm, 1, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.ModulosEfren_Compara_0, 0), (self.blocks_float_to_complex_1, 0))
...
def main(top_block_cls=parteuno, options=None):
