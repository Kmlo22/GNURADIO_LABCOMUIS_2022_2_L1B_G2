...
class PruebaPAM_G2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "CaDu", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CaDu")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PruebaPAM_G2")
        ...
        # Blocks
        ##################################################
        self._fs_range = Range(0, 10000, 100, 1000, 200)
...
def main(top_block_cls=PruebaPAM_G2, options=None):
